...
import ti.webservice.Filtering.exceptions.NonexistentEntityException;
import ti.webservice.Filtering.exceptions.PreexistingEntityException;
...
public class AlattulisJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("ti.webservice_Filtering_jar_0.0.1-SNAPSHOTPU");
